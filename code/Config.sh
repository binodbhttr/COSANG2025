cosa#!/bin/bash            # this line only there to enable syntax highlighting in this file
...
#disk_test
#PARTICLE_TAGGING #Y # enabling this performs live tagging
#TAG_IN_HDF # Y #enabling this performs live tagging in HDF5 files
#TAG_IN_COLLECTIVE
...
MAX_NGB_CHECK=2                    # Max numbers of neighbours for sattlepoint detection (default = 2)
...
NO_ISEND_IRECV_IN_DOMAIN # Commented out by Binod 
...
#VISCOSITY_SUPPRESSION=0.05 # Enables Cullen and Dehnen viscosity suppression outside shocks
