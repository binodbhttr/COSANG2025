...
#ifdef VISCOSITY_SUPPRESSION
  for(k = 0; k < 3; k++)
    in->Accel[k] = P[i].g.GravAccel[k] + SphP[i].a.HydroAccel[k];
#endif
...
#endif
		{
		  ...
		  if(TimeBinActive[P[i].TimeBin])
		      ...
		      if(SphP[i].d.Density > 0)
			{
			  ...
			  for(k = 0; k < 3; k++)
			    {
			      for(ii = 0; ii < 3; ii++)
				{
				  SphP[i].NV_T[ii][k] /= SphP[i].d.Density;
				  SphP[i].NV_D[ii][k] /= SphP[i].d.Density;
				  SphP[i].NV_A[ii][k] /= SphP[i].d.Density;
				}
			    }

			  double detT = SphP[i].NV_T[0][0] * SphP[i].NV_T[1][1] * SphP[i].NV_T[2][2] +
			  ...
			  double dtDV[3][3], Tinv[3][3], A[3][3], V[3][3], St[3][3], S[3][3], Vt[3][3],
			    SSt[3][3];

			  Tinv[0][0] =
			    (SphP[i].NV_T[1][1] * SphP[i].NV_T[2][2] -
			     SphP[i].NV_T[1][2] * SphP[i].NV_T[2][1]) / detT;
			  Tinv[0][1] =
			    (SphP[i].NV_T[0][2] * SphP[i].NV_T[2][1] -
			     SphP[i].NV_T[0][1] * SphP[i].NV_T[2][2]) / detT;
			  Tinv[0][2] =
			    (SphP[i].NV_T[0][1] * SphP[i].NV_T[1][2] -
			     SphP[i].NV_T[0][2] * SphP[i].NV_T[1][1]) / detT;
			  Tinv[1][0] =
			    (SphP[i].NV_T[1][2] * SphP[i].NV_T[2][0] -
			     SphP[i].NV_T[1][0] * SphP[i].NV_T[2][2]) / detT;
			  Tinv[1][1] =
			    (SphP[i].NV_T[0][0] * SphP[i].NV_T[2][2] -
			     SphP[i].NV_T[0][2] * SphP[i].NV_T[2][0]) / detT;
			  Tinv[1][2] =
			    (SphP[i].NV_T[0][2] * SphP[i].NV_T[1][0] -
			     SphP[i].NV_T[0][0] * SphP[i].NV_T[1][2]) / detT;
			  Tinv[2][0] =
			    (SphP[i].NV_T[1][0] * SphP[i].NV_T[2][1] -
			     SphP[i].NV_T[1][1] * SphP[i].NV_T[2][0]) / detT;
			  Tinv[2][1] =
			    (SphP[i].NV_T[0][1] * SphP[i].NV_T[2][0] -
			     SphP[i].NV_T[0][0] * SphP[i].NV_T[2][1]) / detT;
			  Tinv[2][2] =
			    (SphP[i].NV_T[0][0] * SphP[i].NV_T[1][1] -
			     SphP[i].NV_T[0][1] * SphP[i].NV_T[1][0]) / detT;

			  V[0][0] =
			    SphP[i].NV_D[0][0] * Tinv[0][0] + SphP[i].NV_D[0][1] * Tinv[1][0] +
			    SphP[i].NV_D[0][2] * Tinv[2][0];
			  V[0][1] =
			    SphP[i].NV_D[0][0] * Tinv[0][1] + SphP[i].NV_D[0][1] * Tinv[1][1] +
			    SphP[i].NV_D[0][2] * Tinv[2][1];
			  V[0][2] =
			    SphP[i].NV_D[0][0] * Tinv[0][2] + SphP[i].NV_D[0][1] * Tinv[1][2] +
			    SphP[i].NV_D[0][2] * Tinv[2][2];
			  V[1][0] =
			    SphP[i].NV_D[1][0] * Tinv[0][0] + SphP[i].NV_D[1][1] * Tinv[1][0] +
			    SphP[i].NV_D[1][2] * Tinv[2][0];
			  V[1][1] =
			    SphP[i].NV_D[1][0] * Tinv[0][1] + SphP[i].NV_D[1][1] * Tinv[1][1] +
			    SphP[i].NV_D[1][2] * Tinv[2][1];
			  V[1][2] =
			    SphP[i].NV_D[1][0] * Tinv[0][2] + SphP[i].NV_D[1][1] * Tinv[1][2] +
			    SphP[i].NV_D[1][2] * Tinv[2][2];
			  V[2][0] =
			    SphP[i].NV_D[2][0] * Tinv[0][0] + SphP[i].NV_D[2][1] * Tinv[1][0] +
			    SphP[i].NV_D[2][2] * Tinv[2][0];
			  V[2][1] =
			    SphP[i].NV_D[2][0] * Tinv[0][1] + SphP[i].NV_D[2][1] * Tinv[1][1] +
			    SphP[i].NV_D[2][2] * Tinv[2][1];
			  V[2][2] =
			    SphP[i].NV_D[2][0] * Tinv[0][2] + SphP[i].NV_D[2][1] * Tinv[1][2] +
			    SphP[i].NV_D[2][2] * Tinv[2][2];

			  A[0][0] =
			    SphP[i].NV_A[0][0] * Tinv[0][0] + SphP[i].NV_A[0][1] * Tinv[1][0] +
			    SphP[i].NV_A[0][2] * Tinv[2][0];
			  A[0][1] =
			    SphP[i].NV_A[0][0] * Tinv[0][1] + SphP[i].NV_A[0][1] * Tinv[1][1] +
			    SphP[i].NV_A[0][2] * Tinv[2][1];
			  A[0][2] =
			    SphP[i].NV_A[0][0] * Tinv[0][2] + SphP[i].NV_A[0][1] * Tinv[1][2] +
			    SphP[i].NV_A[0][2] * Tinv[2][2];
			  A[1][0] =
			    SphP[i].NV_A[1][0] * Tinv[0][0] + SphP[i].NV_A[1][1] * Tinv[1][0] +
			    SphP[i].NV_A[1][2] * Tinv[2][0];
			  A[1][1] =
			    SphP[i].NV_A[1][0] * Tinv[0][1] + SphP[i].NV_A[1][1] * Tinv[1][1] +
			    SphP[i].NV_A[1][2] * Tinv[2][1];
			  A[1][2] =
			    SphP[i].NV_A[1][0] * Tinv[0][2] + SphP[i].NV_A[1][1] * Tinv[1][2] +
			    SphP[i].NV_A[1][2] * Tinv[2][2];
			  A[2][0] =
			    SphP[i].NV_A[2][0] * Tinv[0][0] + SphP[i].NV_A[2][1] * Tinv[1][0] +
			    SphP[i].NV_A[2][2] * Tinv[2][0];
			  A[2][1] =
			    SphP[i].NV_A[2][0] * Tinv[0][1] + SphP[i].NV_A[2][1] * Tinv[1][1] +
			    SphP[i].NV_A[2][2] * Tinv[2][1];
			  A[2][2] =
			    SphP[i].NV_A[2][0] * Tinv[0][2] + SphP[i].NV_A[2][1] * Tinv[1][2] +
			    SphP[i].NV_A[2][2] * Tinv[2][2];

			  dtDV[0][0] = -V[0][0] * V[0][0] - V[0][1] * V[1][0] - V[0][2] * V[2][0] + A[0][0];
			  dtDV[0][1] = -V[0][0] * V[0][1] - V[0][1] * V[1][1] - V[0][2] * V[2][1] + A[0][1];
			  dtDV[0][2] = -V[0][0] * V[0][2] - V[0][1] * V[1][2] - V[0][2] * V[2][2] + A[0][2];
			  dtDV[1][0] = -V[1][0] * V[0][0] - V[1][1] * V[1][0] - V[1][2] * V[2][0] + A[1][0];
			  dtDV[1][1] = -V[1][0] * V[0][1] - V[1][1] * V[1][1] - V[1][2] * V[2][1] + A[1][1];
			  dtDV[1][2] = -V[1][0] * V[0][2] - V[1][1] * V[1][2] - V[1][2] * V[2][2] + A[1][2];
			  dtDV[2][0] = -V[2][0] * V[0][0] - V[2][1] * V[1][0] - V[2][2] * V[2][0] + A[2][0];
			  dtDV[2][1] = -V[2][0] * V[0][1] - V[2][1] * V[1][1] - V[2][2] * V[2][1] + A[2][1];
			  dtDV[2][2] = -V[2][0] * V[0][2] - V[2][1] * V[1][2] - V[2][2] * V[2][2] + A[2][2];

			  SphP[i].NV_dt_DivVel = dtDV[0][0] + dtDV[1][1] + dtDV[2][2];
			  SphP[i].NV_DivVel = V[0][0] + V[1][1] + V[2][2];
			  if(All.ComovingIntegrationOn)
			    {
			      SphP[i].NV_DivVel /= All.Time * All.Time;
			      SphP[i].NV_dt_DivVel /= All.Time * All.Time;
			    }
			  ...
			  S[0][0] = 0.5 * (V[0][0] + Vt[0][0]) - SphP[i].NV_DivVel / NUMDIMS;
			  S[0][1] = 0.5 * (V[0][1] + Vt[0][1]);
			  S[0][2] = 0.5 * (V[0][2] + Vt[0][2]);
			  S[1][0] = 0.5 * (V[1][0] + Vt[1][0]);
			  S[1][1] = 0.5 * (V[1][1] + Vt[1][1]) - SphP[i].NV_DivVel / NUMDIMS;
			  S[1][2] = 0.5 * (V[1][2] + Vt[1][2]);
			  S[2][0] = 0.5 * (V[2][0] + Vt[2][0]);
			  S[2][1] = 0.5 * (V[2][1] + Vt[2][1]);
			  S[2][2] = 0.5 * (V[2][2] + Vt[2][2]) - SphP[i].NV_DivVel / NUMDIMS;
			  ...
			  SSt[0][0] = S[0][0] * St[0][0] + S[0][1] * St[1][0] + S[0][2] * St[2][0];
			  SSt[0][1] = S[0][0] * St[0][1] + S[0][1] * St[1][1] + S[0][2] * St[2][1];
			  SSt[0][2] = S[0][0] * St[0][2] + S[0][1] * St[1][2] + S[0][2] * St[2][2];
			  SSt[1][0] = S[1][0] * St[0][0] + S[1][1] * St[1][0] + S[1][2] * St[2][0];
			  SSt[1][1] = S[1][0] * St[0][1] + S[1][1] * St[1][1] + S[1][2] * St[2][1];
			  SSt[1][2] = S[1][0] * St[0][2] + S[1][1] * St[1][2] + S[1][2] * St[2][2];
			  SSt[2][0] = S[2][0] * St[0][0] + S[2][1] * St[1][0] + S[2][2] * St[2][0];
			  SSt[2][1] = S[2][0] * St[0][1] + S[2][1] * St[1][1] + S[2][2] * St[2][1];
			  SSt[2][2] = S[2][0] * St[0][2] + S[2][1] * St[1][2] + S[2][2] * St[2][2];

			  SphP[i].NV_trSSt = SSt[0][0] + SSt[1][1] + SSt[2][2];
#endif
...
#ifdef VISCOSITY_SUPPRESSION
      out->NV_A[0][0] +=
	(local->Accel[0] - P[j].g.GravAccel[0] - SphP[j].a.HydroAccel[0]) * kernel->dx * kernel->mj_dwk_r;
      out->NV_A[0][1] +=
	(local->Accel[0] - P[j].g.GravAccel[0] - SphP[j].a.HydroAccel[0]) * kernel->dy * kernel->mj_dwk_r;
      out->NV_A[0][2] +=
	(local->Accel[0] - P[j].g.GravAccel[0] - SphP[j].a.HydroAccel[0]) * kernel->dz * kernel->mj_dwk_r;
      out->NV_A[1][0] +=
	(local->Accel[1] - P[j].g.GravAccel[1] - SphP[j].a.HydroAccel[1]) * kernel->dx * kernel->mj_dwk_r;
      out->NV_A[1][1] +=
	(local->Accel[1] - P[j].g.GravAccel[1] - SphP[j].a.HydroAccel[1]) * kernel->dy * kernel->mj_dwk_r;
      out->NV_A[1][2] +=
	(local->Accel[1] - P[j].g.GravAccel[1] - SphP[j].a.HydroAccel[1]) * kernel->dz * kernel->mj_dwk_r;
      out->NV_A[2][0] +=
	(local->Accel[2] - P[j].g.GravAccel[2] - SphP[j].a.HydroAccel[2]) * kernel->dx * kernel->mj_dwk_r;
      out->NV_A[2][1] +=
	(local->Accel[2] - P[j].g.GravAccel[2] - SphP[j].a.HydroAccel[2]) * kernel->dy * kernel->mj_dwk_r;
      out->NV_A[2][2] +=
	(local->Accel[2] - P[j].g.GravAccel[2] - SphP[j].a.HydroAccel[2]) * kernel->dz * kernel->mj_dwk_r;

      out->NV_D[0][0] += kernel->dvx * kernel->dx * kernel->mj_dwk_r;
      out->NV_D[0][1] += kernel->dvx * kernel->dy * kernel->mj_dwk_r;
      out->NV_D[0][2] += kernel->dvx * kernel->dz * kernel->mj_dwk_r;
      out->NV_D[1][0] += kernel->dvy * kernel->dx * kernel->mj_dwk_r;
      out->NV_D[1][1] += kernel->dvy * kernel->dy * kernel->mj_dwk_r;
      out->NV_D[1][2] += kernel->dvy * kernel->dz * kernel->mj_dwk_r;
      out->NV_D[2][0] += kernel->dvz * kernel->dx * kernel->mj_dwk_r;
      out->NV_D[2][1] += kernel->dvz * kernel->dy * kernel->mj_dwk_r;
      out->NV_D[2][2] += kernel->dvz * kernel->dz * kernel->mj_dwk_r;

      out->NV_T[0][0] += kernel->dx * kernel->dx * kernel->mj_dwk_r;
      out->NV_T[0][1] += kernel->dx * kernel->dy * kernel->mj_dwk_r;
      out->NV_T[0][2] += kernel->dx * kernel->dz * kernel->mj_dwk_r;
      out->NV_T[1][0] += kernel->dy * kernel->dx * kernel->mj_dwk_r;
      out->NV_T[1][1] += kernel->dy * kernel->dy * kernel->mj_dwk_r;
      out->NV_T[1][2] += kernel->dy * kernel->dz * kernel->mj_dwk_r;
      out->NV_T[2][0] += kernel->dz * kernel->dx * kernel->mj_dwk_r;
      out->NV_T[2][1] += kernel->dz * kernel->dy * kernel->mj_dwk_r;
      out->NV_T[2][2] += kernel->dz * kernel->dz * kernel->mj_dwk_r;
#endif
